...
import { Coins, LogOut, MessageSquare, PanelLeft, PanelRight, PenBoxIcon, Plus, User } from "lucide-react";
  ...
  if(collapsed){
    return (
      <div className='hidden lg:flex flex-col items-center w-[56px] h-screen bg-[#0d0f14] border-r border-white/[0.06] py-4 gap-1 shrink-0'>
        <button className='flex items-center justify-center w-9 h-9 rounded-xl text-slate-500 hover:text-slate-200 hover:bg-white/[0.05] transition-colors duration-colors duration 150 bg transparent border-none cursor-pointer mb-1'
            ...
            {userData?(
              <div className="flex items-center gap-2.5 cursor-pointer rounded-xl px-3 py-2.5 hover:bg-white/[0.05] transition-colors duration-150">
                ...
                <div className='flex gap-1'>
                  ...
                  <button className='flex items-center justify-center w-7 h-7 rounded-[7px] border-none bg-transparent text-slate-600 cursor-pointer hover:bg-white/[0.06] hover:text-slate-400 transition-all duration-150' onClick={()=>{logOut();dispatch(setUserdata(null))}}>
                    <LogOut size={16}/>
                  </button>
              ...
              :
              <button className='w-full flex items-center justify-center gap-2 text-sm font-medium font-medium text-slate-200 bg-white/[0.05] border border-white/[0.08] rounded-xl py-[11px] cursor-pointer hover:bg-white/[0.08] transition-colors duration-150'>
                Login
              </button>
           }
          </div>
